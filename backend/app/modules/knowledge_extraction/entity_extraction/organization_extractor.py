"""Organization entity extractor using spaCy NLP."""
...
class OrganizationExtractor(BaseEntityExtractor):
    """Extractor for organization entities using spaCy NER."""
    ...
    def _load_spacy_model(self):
        ...
        try:
            ...
            print("spaCy not installed, OrganizationExtractor will not work")
    ...
    def _calculate_confidence(self, org_name: str, context: str) -> float:
        confidence = 0.7
        context_lower = context.lower()
        org_keywords = ['company', 'corporation', 'ltd', 'llc', 'inc', 'organization']
